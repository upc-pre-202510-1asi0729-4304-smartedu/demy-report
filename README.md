...
| WeeklySchedules    | DELETE      | {weeklyScheduleId} {scheduleId} | /api/v1/weekly-schedules/{weeklyScheduleId}/schedules/{scheduleId} | Elimina un horario del horario semanal                      |
