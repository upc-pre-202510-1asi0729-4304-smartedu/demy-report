...
- US04: Recuperar contraseña mediante correo electrónico
    ![imagesExecutionEvidence1](./assets/images/Execution_Evidence_for_Sprint_Review_sprint_3_Open_Source/US04.png)

#### 5.2.3.7. Software Deployment Evidence for Sprint Review.
Para la entrega de este tercer sprint, se implementó la web application de manera parcial.

1. Recuperar Contraseña: Vista donde podremos ingresar nuestro correo electronico para recuperar contraseña.
    ![imagesSoftwareDeploymentEvidence](./assets/images/Software_Deployment_Evidence_for_Sprint_Review_sprint_3_Open_Source/forgot-password.png)

2. Resetear Contraseña: Vista donde podremos actualizar nuestra contraseña.
   ![imagesSoftwareDeploymentEvidence](./assets/images/Software_Deployment_Evidence_for_Sprint_Review_sprint_3_Open_Source/reset-password.png)
